...
export default class App {
	...
	private middleware(): void {
		...
		const corsOptions = {
			origin: ['http://localhost:8080', 'http://localhost:30000', 'http://127.0.0.1:30000', 'http://localhost:30001', 'http://127.0.0.1:30001',  'http://127.0.0.1:3146', 'http://127.0.0.1:8080'],
		};
